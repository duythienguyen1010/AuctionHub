...
router.get('/:id/new', isLoggedIn, hasTrade, controller.new);

//POST /offers: create a new offer
router.post('/create', isLoggedIn, hasTrade, controller.create);
...
router.get('/update/:id', validateId, isLoggedIn, isCreator, hasTrade, controller.edit);

//PUT /update/:id: update offer
router.put('/update/:id', validateId, isLoggedIn, isCreator, hasTrade, controller.update);
